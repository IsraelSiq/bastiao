...
- Revisão de PRs e sugestões de correção.
- Painel de saúde do Bastião.
- Alertas de disco, temperatura e falhas de container.
- Interface de voz.
- Integrações selecionadas com Drive, Supabase e outros serviços.
